...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[570,241,412,96],[312,339,399,72],[810,0,48,48],[312,413,475,45],[570,0,238,239],[0,0,310,432],[312,0,256,257]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-102.95,-24.1,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.tx, new cjs.Rectangle(-102.9,-24.1,206,48), null);
...
if (reversed == null) { reversed = false; }
	...
	this.tx = new lib.tx();
	this.tx.name = "tx";
	this.tx.setTransform(244.65,-17,0.8313,0.8306);
...
// stage content:
(lib.kama_100per90_quadro_mt = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
